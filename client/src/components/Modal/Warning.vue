<script setup lang="ts">
  const props = defineProps<{ showWarning: boolean, warningMessage : string,  }>()
            ...
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
              <div class="sm:flex sm:items-start">
                ...
                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                  <h3 class="text-2xl font-medium leading-6 text-gray-900" id="modal-title">Peringatan</h3>
                  <div class="mt-2">
                    <p class="text-lg text-gray-500">{{ warningMessage }}</p>
                  </div>
                </div>
              </div>
            </div>
