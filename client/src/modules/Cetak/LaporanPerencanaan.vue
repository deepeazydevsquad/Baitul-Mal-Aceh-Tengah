...
<template>
  ...
  <div v-else class="min-h-screen p-4 print:p-0 print:m-0 bg-white">
    <div
    ...
    >
      ...
      <!-- Tabel -->
      <table class="w-full text-[8pt] bg-white mt-4 mb-4 border-collapse print-table" style="table-layout: fixed">
        <thead class="bg-white border-b-2 border-black border text-center">
          <tr>
        ...
        <tbody class="divide-y divide-gray-200">
            <template v-if="datas && datas.length > 0">
              <template v-for="asnaf in datas" :key="asnaf.nama">
                <!-- Baris Asnaf -->
                <tr class="font-semibold text-black text-[8pt] bg-white">
              ...
              <!-- Grand Total -->
              <tr class="font-bold text-black bg-white">
