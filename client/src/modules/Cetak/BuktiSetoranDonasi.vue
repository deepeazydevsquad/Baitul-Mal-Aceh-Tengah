...
import { info_bukti_setoran } from '@/service/riwayat_donasi';
...
onMounted(async () => {
  try {
    ...
    document.title = `Bukti Setoran Donasi`;
      ...
      <div class="flex flex-col min-h-[130mm]">
        ...
        <div class="flex-1">
          ...
          <table class="border-collapse text-[8pt] mb-2 w-full">
            ...
            <thead>
              <tr>
                <th colspan="4" class="border px-2 py-2 text-center">Tanda Penerimaan Donasi</th>
              </tr>
            </thead>
            <tbody>
              <tr>
              ...
              <tr>
                <td class="px-2 py-1">Nama program</td>
                <td class="px-2 py-1 text-center">:</td>
                <td class="px-2 py-1 font-bold italic">{{ buktiData.program }}</td>
              </tr>
              <tr>
            ...
            <tbody>
              ...
              <tr>
                <td class="px-2 pt-6 pb-1 text-center italic font-xs" colspan="4">
                  YA ALLAH BERIKANLAH PAHALA ATAS DONASI YANG DIBERIKAN DAN BERKAHILAH HARTA YANG
                  LAINNYA. AMIN
                </td>
              </tr>
            </tbody>
