...
import { info_bukti_setoran } from '@/service/riwayat_infaq';
      ...
      <div class="flex flex-col min-h-[130mm]">
        ...
        <div class="flex-1">
          ...
          <table class="border-collapse text-[8pt] mb-2 w-full">
            ...
            <thead>
              <tr>
                <th colspan="4" class="border px-2 py-2 text-center">Tanda Penerimaan Infaq</th>
              </tr>
            </thead>
            <tbody>
              <tr>
            ...
            <tbody>
              ...
              <tr>
                <td class="px-2 pt-6 pb-1 text-center italic font-xs" colspan="4">
                  YA ALLAH BERIKANLAH PAHALA ATAS INFAQ YANG DIBERIKAN DAN BERKAHILAH HARTA YANG
                  LAINNYA. AMIN
                </td>
              </tr>
            </tbody>
